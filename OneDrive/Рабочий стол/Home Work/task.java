...
public class task{
    public static void main(String[] args) {
        Notebook lap1=new Notebook("A5",1236,"Xiaomi");
        lap1.setColor("black");
        lap1.setHDD(700);
        lap1.setOS("Windows");
        lap1.setRAM(8);
        ...
        Notebook lap3=new Notebook("AB97",67201,"Acer");
        lap3.setColor("rose");
        lap3.setHDD(900);
        lap3.setOS("Windows");
        lap3.setRAM(16);

        Notebook lap4=new Notebook("OMAN11",1111,"hp");
        lap4.setColor("black");
        lap4.setHDD(700);
        lap4.setOS("Linux");
        lap4.setRAM(8);

        Notebook lap5=new Notebook("MAC101",8438483,"Apple");
        lap5.setColor("silver");
        lap5.setHDD(1000);
        lap5.setOS("macOS");
        lap5.setRAM(8);

        HashSet <Notebook> laptops = new HashSet<>(Arrays.asList(lap1,lap2,lap3,lap4,lap5));
